...
const groups = JSON.parse(fs.readFileSync("../../groups/list.json")).symbols.map(s => `http://udf-proxy.tradingview.com:8094/symbols??perm=*&domain=tvbs&typespecs=main&prefix=${s.s}`);
